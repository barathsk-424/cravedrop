...
import { Mail, Lock, Eye, EyeOff, User, Phone, ChefHat, ArrowRight } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] relative overflow-hidden p-6 py-20">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm font-bold text-[var(--text-tertiary)] uppercase tracking-[0.3em] mt-2">
            Join the elite Culinary Haven
          </p>
        </div>

        {/* Form Container */}
        <div className="bg-[var(--bg-card)]/80 backdrop-blur-2xl rounded-[3rem] p-8 md:p-12 shadow-[var(--shadow-xl)] border border-[var(--glass-border)]">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <User size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)] group-focus-within:text-[var(--primary)] transition-colors" />
                  <input
                    type="text"
                    name="fullName"
                    ...
                    required
                    className="w-full h-16 pl-14 pr-6 rounded-2xl bg-[var(--bg-elevated)] border border-transparent focus:border-[var(--primary)]/30 text-[var(--text-primary)] font-bold placeholder:text-[var(--text-tertiary)]/50 text-base shadow-inner focus:bg-white transition-all outline-none"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Mail size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)] group-focus-within:text-[var(--primary)] transition-colors" />
                  <input
                    type="email"
                    name="email"
                    value={formData.email}
                    onChange={handleChange}
                    placeholder="john@haven.com"
                    required
                    className="w-full h-16 pl-14 pr-6 rounded-2xl bg-[var(--bg-elevated)] border border-transparent focus:border-[var(--primary)]/30 text-[var(--text-primary)] font-bold placeholder:text-[var(--text-tertiary)]/50 text-base shadow-inner focus:bg-white transition-all outline-none"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Phone size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)] group-focus-within:text-[var(--primary)] transition-colors" />
                  <input
                    type="tel"
                    name="phone"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Lock size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)] group-focus-within:text-[var(--primary)] transition-colors" />
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full h-16 pl-14 pr-14 rounded-2xl bg-[var(--bg-elevated)] border border-transparent focus:border-[var(--primary)]/30 text-[var(--text-primary)] font-bold placeholder:text-[var(--text-tertiary)]/50 text-base shadow-inner focus:bg-white transition-all outline-none"
                  />
                  <button
                    type="button"
            ...
            {/* Terms */}
            <div className="p-4 rounded-2xl bg-[var(--bg-elevated)]/50 border border-transparent hover:border-[var(--glass-border)] transition-all">
              <p className="text-[10px] font-bold text-[var(--text-tertiary)] uppercase tracking-widest leading-relaxed">
                By requesting access, you agree to our 
                <Link href="#" className="text-[var(--primary)] ml-1 hover:underline">Membership Terms</Link> and 
                <Link href="#" className="text-[var(--primary)] ml-1 hover:underline">Privacy Charter</Link>.
              </p>
            </div>
          ...
          {/* Social */}
          <button className="group w-full h-16 rounded-2xl border-2 border-[var(--glass-border)] bg-white text-[var(--text-primary)] font-black text-[10px] uppercase tracking-[0.2em] hover:border-[var(--primary)] transition-all flex items-center justify-center gap-3 cursor-pointer shadow-sm active:scale-95">
